...
export function createDeclaredCommands(build: DepsBuilder): Pick<WorkspaceCommands, 'actions' | 'deleteAction' | 'views' | 'deleteView' | 'subscriptions' | 'deleteSubscription' | 'declare' | 'declarations' | 'undeclare' | 'evaluate'> {
  return {
