/* GENERATED — synced from platform/ui/render-hints.ts by scripts/sync-platform-ui.mjs.
 * Do NOT edit here; edit platform/ui/render-hints.ts and re-run the sync. Source-bundled so the
