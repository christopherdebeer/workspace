...
.wta{position:relative}.wta textarea{width:100%;box-sizing:border-box}.wta-pop{position:absolute;left:0;right:0;top:100%;z-index:50;margin-top:.2rem;display:grid;gap:.2rem;padding:.4rem;border:1px solid var(--line);border-radius:8px;background:#fff;box-shadow:0 4px 16px rgba(51,46,35,.14);max-height:15rem;overflow:auto}
