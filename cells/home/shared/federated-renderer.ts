/* GENERATED — synced from platform/ui/federated-renderer.ts by scripts/sync-platform-ui.mjs.
 * Do NOT edit here; edit platform/ui/federated-renderer.ts and re-run the sync. Source-bundled so the
