...
export const SWITCHES = [
  ...
  { id: 'swardsites', kind: 'number', marks: ['look', 'bench'], fallback: '5 sites/m\u00b2',
    note: 'swardsites= the NOMINAL site density the sward asks for, in tufts per square metre before the grass dial. It is not lushness: a lattice of step s holds one tuft per cell, so anything above about five saturates the middle and far carriers and draws the rings it was meant to hide (the old value was fourteen). Everything the carriers cannot carry is spent on tuft SPREAD instead — see SWARD_SITES' },
