...
export const SWITCHES = [
  ...
  { id: 'built', kind: 'toggle', marks: ['world'], apply: 'world', fallback: 'the BUILT WORLD dial (on)',
  ...
  { id: 'authored', kind: 'toggle', marks: ['world'], apply: 'world', fallback: 'the AUTHORED dial (on)',
  ...
  { id: 'time', kind: 'choice', marks: ['look'], apply: 'live', fallback: 'the remembered clock',
    note: 'clock mode by name (NOON, DUSK, CYCLE…)' },
  { id: 't', kind: 'choice', marks: ['look'], apply: 'live', fallback: 'the remembered clock',
    note: 'the same as time, kept because links carry it' },
  { id: 'sunalt', kind: 'number', marks: ['look', 'bench'], apply: 'live', fallback: 'the clock’s own sun',
    note: 'pin the sun’s altitude in degrees, −20..89' },
  { id: 'substrate', kind: 'choice', marks: ['bench', 'legacy'], fallback: 'the substrate owns the picture',
    note: "the road/terrain/water substrate (SUBSTRATE-MIGRATION.md). The default is now `render`: every terrain, carriageway, structure, batter and hydro packet is COMMITTED by the tile that owns it before any of it is drawn, so a tile's picture changes in one atomic revision. contact = the substrate answers the wheels and the legacy owners draw, which is the rollback and the A/B for anything the render path is blamed for; shadow = legacy contact with the substrate observed; legacy = the pre-substrate contact with shadow diagnostics; off = every consumer down. It was read round the typed reader and so was in no list until it was declared here" },
  { id: 'bridgeforms', kind: 'toggle', marks: ['bench', 'legacy'], apply: 'world', fallback: 'a bridge paints its towers, cables, ribs and lattice',
  ...
  { id: 'bridgedem', kind: 'toggle', marks: ['bench', 'legacy'], apply: 'world', fallback: 'a tagged bridge takes its deck out of the DEM',
  ...
  { id: 'hydroground', kind: 'number', marks: ['bench'], apply: 'world', fallback: '150 m round the water',
  ...
  { id: 'hydroeps', kind: 'number', marks: ['bench'], apply: 'world', fallback: '2 cm of bed',
  ...
  { id: 'vegstep', kind: 'number', marks: ['bench'], apply: 'live', fallback: 'a sixth of the frame, 5 ms at least',
  ...
  { id: 'farpark', kind: 'number', marks: ['bench'], apply: 'live', fallback: '48 MB of parked shell',
  ...
  { id: 'wx', kind: 'choice', marks: ['look', 'bench'], apply: 'live', fallback: 'the live weather',
    note: 'pin the sky: clear, haze, rain or storm' },
  { id: 'fog', kind: 'number', marks: ['look', 'bench'], apply: 'live', fallback: 'the live mist',
    note: 'pin the regional mist, 0..1' },
  { id: 'wet', kind: 'number', marks: ['look', 'bench'], apply: 'live', fallback: 'the live ground',
    note: 'flood the ground so a puddle shot need not wait out a storm, 0..1' },
  { id: 'wind', kind: 'number', marks: ['look', 'bench'], apply: 'live', fallback: 'the live wind',
    note: 'force the wind in km/h — nothing wind-driven can be judged on a calm day' },
  { id: 'winddir', kind: 'number', marks: ['look', 'bench'], apply: 'live', fallback: 'the live bearing',
  ...
  { id: 'mblur', kind: 'number', marks: ['look'], apply: 'live', fallback: 'the remembered dial',
    note: 'the motion-blur dial, so a screenshot can state its own conditions' },
  { id: 'dofs', kind: 'choice', marks: ['look', 'bench'], apply: 'live', fallback: 'the remembered DOF strength',
    note: 'ordinary depth-of-field strength: off, subtle, stock or strong; camera geometry is derived from the active view' },
  { id: 'dof', kind: 'choice', marks: ['look', 'bench'], apply: 'live', fallback: 'the camera policy',
    note: 'expert depth-of-field geometry override: off, camera or miniature; bypasses the ordinary per-camera policy' },
  { id: 'dofq', kind: 'choice', marks: ['look', 'bench'], apply: 'live', fallback: 'medium',
    note: 'expert depth-of-field gather quality: low, med or high' },
  { id: 'aperture', kind: 'number', marks: ['look', 'bench'], apply: 'live', fallback: 'the camera policy',
    note: 'expert depth-of-field aperture override, 0..3 (4, 7, 11 or 15 art pixels)' },
  { id: 'focus', kind: 'number', marks: ['look', 'bench'], apply: 'live', fallback: 'the rendered centre subject',
    note: 'expert depth-of-field focus override, 0..5 (auto, 15, 30, 60, 150 or 600 metres)' },
  { id: 'near', kind: 'number', marks: ['bench'], apply: 'live', fallback: 'derived per frame',
  ...
  { id: 'wash', kind: 'number', marks: ['look'], apply: 'world', fallback: '0.1',
    note: 'how far a cut face washes toward the verge' },
  { id: 'slip', kind: 'number', marks: ['look'], apply: 'live', fallback: '1',
  ...
  { id: 'treetris', kind: 'number', marks: ['bench'], apply: 'live', fallback: '2.4M',
    note: 'the baked-tree triangle budget, unsaved and exact' },
  { id: 'treerange', kind: 'number', marks: ['bench'], apply: 'live', fallback: '700 m',
    note: 'tree draw range, unsaved and exact' },
  { id: 'treepop', kind: 'number', marks: ['bench'], apply: 'live', fallback: '1×',
    note: 'tree population multiplier, unsaved and exact' },
  { id: 'swardnear', kind: 'number', marks: ['look', 'bench'], apply: 'live', fallback: '3×',
  ...
  { id: 'ezfullpx', kind: 'number', marks: ['bench'], apply: 'live', fallback: '58 px',
  ...
  { id: 'refr', kind: 'number', marks: ['bench'], apply: 'world', fallback: '1100 m',
  ...
  { id: 'nodraw', kind: 'toggle', marks: ['bench'], apply: 'live', fallback: 'off',
  ...
  { id: 'fling', kind: 'toggle', marks: ['look'], apply: 'live', fallback: 'on',
  ...
  { id: 'widedither', kind: 'toggle', marks: ['look'], apply: 'live', fallback: 'on',
  ...
  { id: 'banklook', kind: 'number', marks: ['look', 'legacy'], apply: 'field', fallback: '1 (the narrow damp bank)',
    note: 'banklook=0 brings back the wide bare bank: the 4.5-10 m wet margin and 12 m mineral margin that shaved the sward to a pale strip beside inland water (seen at the Senqu). 1, the default since the hydro review, is a narrow damp line with grass close to the water' },
  { id: 'hydrolook', kind: 'number', marks: ['look', 'legacy'], apply: 'live', fallback: '1 (the reviewed optics)',
    note: 'hydrolook=0 brings back the water optics before the hydro review: a sky reflection dimmed twice and capped at 46%, water-only terms painted over the waterline, nearest-sampled class steps, regular ripple rings, no moon path and no night body dimming. 1 is the default (HydroTuning.lookModel)' },
  ...
  { id: 'bank', kind: 'toggle', marks: ['legacy', 'world'], apply: 'world', fallback: 'on',
  ...
  { id: 'fords', kind: 'toggle', marks: ['legacy', 'world'], apply: 'world', fallback: 'on',
  ...
  { id: 'bldruns', kind: 'toggle', marks: ['legacy'], apply: 'world', fallback: 'on',
  ...
  { id: 'ezstand', kind: 'toggle', marks: ['legacy'], apply: 'world', fallback: 'per stand',
    note: 'ezstand=0 picks a silhouette per POSITION — what every wood looked like before' },
  { id: 'guild', kind: 'toggle', marks: ['legacy'], apply: 'world', fallback: 'the guild',
    note: 'guild=0 chooses plants by the five-biome climate path alone' },
  { id: 'refine', kind: 'toggle', marks: ['legacy'], apply: 'world', fallback: 'the corridor',
  ...
  { id: 'lumasync', kind: 'toggle', marks: ['legacy'], apply: 'live', fallback: 'asynchronous',
    note: 'lumasync=1 reads the luma map synchronously, as it used to' },
  { id: 'treedemand', kind: 'toggle', marks: ['legacy'], apply: 'live', fallback: 'by demand',
  ...
  { id: 'impreach', kind: 'number', marks: ['bench'], apply: 'live', fallback: 'the draw range (the IMPOSTOR REACH dial at 1X)',
  ...
  { id: 'impdensity', kind: 'number', marks: ['bench'], apply: 'live', fallback: '1 (the IMPOSTOR DENSITY dial at 1X)',
  ...
  { id: 'treeprice', kind: 'toggle', marks: ['legacy'], apply: 'live', fallback: 'as drawn',
  ...
  { id: 'drapefast', kind: 'toggle', marks: ['legacy'], apply: 'world', fallback: 'bound',
    note: 'drapefast=0 makes a redrape pay the tile lookup on every vertex again' },
  { id: 'hydroskip', kind: 'toggle', marks: ['legacy'], apply: 'world', fallback: 'skip',
  ...
  { id: 'vegseed', kind: 'toggle', marks: ['legacy'], apply: 'live', fallback: 'budgeted',
    note: 'vegseed=0 seeds a whole ring in one call, as it did at 95 ms' },
  { id: 'relief', kind: 'toggle', marks: ['legacy'], apply: 'world', fallback: 'on',
  ...
  { id: 'hull', kind: 'toggle', marks: ['legacy'], apply: 'live', fallback: 'on',
  ...
  { id: 'bldface', kind: 'toggle', marks: ['legacy'], apply: 'world', fallback: 'on',
    note: 'bldface=0 leaves every building extrusion inside-out, as it was' },
  { id: 'bldpara', kind: 'toggle', marks: ['legacy'], apply: 'world', fallback: 'on',
  ...
  { id: 'ezgrain', kind: 'number', marks: ['look'], apply: 'live', fallback: '0.9',
  ...
  { id: 'raincurtain', kind: 'toggle', marks: ['look'], apply: 'live', fallback: 'on',
  ...
  { id: 'paintwash', kind: 'number', marks: ['look'], apply: 'live', fallback: '0 (off)',
    note: 'paintwash=0..1 blends toward the composite soft buffer before grade and quantise — exploratory painterly pre-pass so neighbouring materials share a little colour; 0 is the shipped truth' },
  ...
  { id: 'swardfull', kind: 'number', marks: ['look', 'bench'], apply: 'live', fallback: '1.15\u00d7',
  ...
  { id: 'swardcap', kind: 'toggle', marks: ['look', 'legacy', 'bench'], apply: 'live', fallback: 'on',
  ...
  { id: 'swardsites', kind: 'number', marks: ['look', 'bench'], apply: 'live', fallback: '12 sites/m\u00b2',
  ...
  { id: 'swardsub', kind: 'toggle', marks: ['look', 'legacy'], apply: 'field', fallback: 'on',
  ...
  { id: 'swardev', kind: 'toggle', marks: ['look', 'legacy'], apply: 'field', fallback: 'on',
  ...
  { id: 'swardforms', kind: 'toggle', marks: ['look', 'legacy'], apply: 'live', fallback: 'on',
  ...
  { id: 'tilt', kind: 'choice', marks: ['look'], apply: 'live', fallback: 'stock',
  ...
  { id: 'vegstems', kind: 'number', marks: ['world', 'legacy'], apply: 'world', fallback: '1',
  ...
  { id: 'steepfill', kind: 'number', marks: ['look'], apply: 'live', fallback: '0.18',
  ...
  { id: 'impink', kind: 'number', marks: ['bench'], apply: 'live', fallback: '0',
