...
import { PendingCover, PendingNote, PendingRail } from './Pending';
...
export function Discover({ books, authed, pending, onJoin, onAdd, onManage, onOpenBook, onViewProfile, onLookupIsbn }: { books: DiscoverCopy[]; authed: boolean; /** Nothing has loaded yet — say so, rather than showing an empty shelf as fact. */ pending?: boolean; onJoin: () => void; onAdd: () => void; onManage: () => void; onOpenBook: (workId: string) => void; onViewProfile: (profileId: string) => void; onLookupIsbn: (isbn: string) => Promise<void> }): React.JSX.Element {
