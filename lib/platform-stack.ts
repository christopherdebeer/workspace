...
export class PlatformStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: PlatformStackProps) {
    ...
    const cells = new HttpServiceCell(this, 'CellsService', {
      ...
      commands: ['create', 'list', 'get', 'call', 'grant', 'revoke', 'delete', 'logs', 'describeTools', 'catalogCells', 'describeCellTools', 'callCellTool', 'describeTypes', 'writeFile', 'replaceInFile', 'appendToFile', 'readFile', 'listFiles', 'searchFiles', 'deleteFile', 'deploy', 'putData', 'getData', 'listData'],
